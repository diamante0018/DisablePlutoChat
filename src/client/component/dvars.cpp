...
namespace dvars
{
  ...
  {
    template <typename T>
    T* find_dvar(std::unordered_map<std::string, T>& map,
  ...
  namespace override
  {
    ...
    static std::unordered_map<std::string, dvar_string>
        register_string_overrides;

    void Dvar_RegisterBool(const std::string& name, const bool value,
    ...
    void Dvar_RegisterFloat(const std::string& name, const float value,
    ...
    void Dvar_RegisterInt(const std::string& name, const int value,
    ...
    void Dvar_RegisterString(const std::string& name, const std::string& value,
                             const unsigned short flags,
                             const std::string& description)
    {
      dvar_string values;
  ...
  game::dvar_t* dvar_register_bool(const char* name, bool value,
                                   unsigned short flags,
                                   const char* description)
  {
    ...
    return dvar_register_bool_hook.invoke<game::dvar_t*>(
        name, value, flags, description);
  }

  game::dvar_t* dvar_register_float(const char* name, float value, float min,
                                    ...
                                    const char* description)
  {
    ...
    return dvar_register_float_hook.invoke<game::dvar_t*>(
        name, value, min, max, flags, description);
  }

  game::dvar_t* dvar_register_int(const char* name, int value, int min, int max,
                                  unsigned short flags, const char* description)
  {
    ...
    return dvar_register_int_hook.invoke<game::dvar_t*>(
        name, value, min, max, flags, description);
  }

  game::dvar_t* dvar_register_string(const char* name, const char* value,
                                     unsigned short flags,
                                     const char* description)
  {
    ...
    return dvar_register_string_hook.invoke<game::dvar_t*>(
        name, value, flags, description);
  }
